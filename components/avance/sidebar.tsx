  ...
  return (
    <SidebarShell>
      <aside className="flex h-screen w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        <div className="relative flex items-center justify-between gap-2 border-b border-sidebar-border/50 px-5 py-5 pr-12 lg:pr-3">
          <Link
            href="/inicio"
          ...
          >
            ...
            <div className="flex min-w-0 flex-col">
              <span className="truncate text-sm font-bold leading-tight">Avance MentorMed</span>
